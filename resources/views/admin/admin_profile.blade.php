    ...
    <div class="row">
      <div class="col-sm-5 mx-auto">
        <div class="card">
          <div class="card-header pb-0">
            ...
            <h4 style="text-align: right"><i data-toggle="tooltip" data-placement="bottom" title="Edit basic info." class="fa fa-edit float-right" id="trigger_user_basic_edit" style="font-size:21px;cursor:pointer"></i></h4>
          </div>
          <div class="card-body">
            <div class="row">
                <div class="col-lg-4">
            ...
            <div class="card-body" id="user_basic_edit" style="display: none">
              <form class="theme-form" action="" id="update_basic_info_form" method="POST">
                  ...
                  <div class="row">
                      <div class="col-lg-12">
                          <button type="submit" id="update_basic_info_button" class="btn btn-info form-control btn-square">Update Profile Info</button>
                      </div>
                  </div>
      ...
      <div class="col-sm-5 mx-auto">
        <div class="card">
          ...
          <div class="card-body">
              <form class="theme-form" action="" id="change_password_form" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="input-group col-md-8 mb-3">
                        ...
                        <span style="border: 1px solid gray" class="input-group-text " id="basic-addon4" onclick="password_status('old_password','basic-addon4')"><i class="fa fa-eye"></i></span>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="input-group col-md-8 mb-3">
                        ...
                        <span style="border: 1px solid gray" class="input-group-text" id="basic-addon3" onclick="password_status('new_password','basic-addon3')"><i class="fa fa-eye"></i></span>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-4 my-0">
                    ...
                    <div class="input-group col-md-8 mb-3">
                        ...
                        <span style="border: 1px solid gray" class="input-group-text" id="basic-addon2" onclick="password_status('retype_password','basic-addon2')"><i class="fa fa-eye"></i></span>
                    </div>
                </div>
                
                <button type="submit" id="update_password_button" class="btn btn-success form-control btn-square">Change Password</button>
            </form>
            <script>
